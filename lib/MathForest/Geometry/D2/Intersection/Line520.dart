...
import '../../../Algebra/Solver/TrigonometricSolver.dart'
    as trigonometric_solver;
...
DPoint xConic2Line(Conic2 c, Line l) {
  DNum dt = polynomial_solver.solveQuadratic(
    c.u.x * l.v.y - c.u.y * l.v.x,
    c.p.x * l.v.y - l.p.x * l.v.y - c.p.y * l.v.x + l.p.y * l.v.x,
    c.v.x * l.v.y - c.v.y * l.v.x,
  );
  return c.indexDPoint(dt);
}

// 直线和交叉直线
DPoint xXLineLine(XLine c, Line l) {
  return DPoint(xLineLine(c.l1, l), xLineLine(c.l2, l));
}
